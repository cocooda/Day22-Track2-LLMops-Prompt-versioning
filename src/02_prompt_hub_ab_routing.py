...
# Tên duy nhất trong Hub của bạn
PROMPT_V1_NAME = "duc-nguyen-day22-rag-prompt-v1"
PROMPT_V2_NAME = "duc-nguyen-day22-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
# V1: concise, friendly, direct
SYSTEM_V1 = (
    "You are a helpful AI assistant. Use ONLY the following context to answer the question.\n\n"
    "Context:\n{context}\n\n"
    "Keep your answer concise and direct (2-4 sentences). "
...
# V2: structured, professional, with answer/source/confidence style
SYSTEM_V2 = (
    "You are an expert AI analyst. Carefully read the context below, identify the relevant facts, "
    "and provide a clear, well-organized response.\n\n"
    "Context:\n{context}\n\n"
    "Structure your answer as follows:\n"
    "**Answer:** (3-5 sentences with a thorough explanation)\n"
    "**Key Points:** (bullet points of the main facts)\n"
...
def push_prompts_to_hub(client: Client):
    ...
    # Push PROMPT_V1
    try:
        url = client.push_prompt(PROMPT_V1_NAME, object=PROMPT_V1, description="V1 – Concise and friendly, 2-4 sentence direct answers")
    ...
    # Push PROMPT_V2
    try:
        url = client.push_prompt(PROMPT_V2_NAME, object=PROMPT_V2, description="V2 – Structured professional with Answer/Key Points/Confidence format")
