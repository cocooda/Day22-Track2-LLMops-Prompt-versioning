...
def collect_rag_outputs(vectorstore, prompt_version: str) -> list:
    ...
    for i, qa in enumerate(QA_PAIRS, 1):
        ...
        time.sleep(4.5)  # 15 RPM limit = 1 req / 4s, so wait 4.5s
...
def run_ragas_eval(rag_results: list, version: str) -> dict:
    ...
    # Tạo EvaluationDataset từ rag_results (limit to 5 to avoid quota exceeded)
    dataset = build_ragas_dataset(rag_results[:5])
